...
<div id="page">
  <div id="content">
    ...
    <h2>More sponsors</h2>
    <p>The money from the Internet Infrastructure Foundation is since long time gone and we are looking for sponsors to keep the site up and running. If you are intrested, <a href="https://twitter.com/soulislove">tweet me</a> or use the Paypal donate button below.
    </p>
  </div>
</div>
